...
function retrieveNotes()
{
    ...
    if(todo_list=="null") {
      ...
      JSON.parse(todo_list).forEach(task => {
...
dragTodoHeader.addEventListener("mousedown", function(event) {
    let shiftX = event.clientX - dragTodo.getBoundingClientRect().left;
    let shiftY = event.clientY - dragTodo.getBoundingClientRect().top;

    function moveAt(pageX, pageY) {
        dragTodo.style.left = pageX - shiftX + "px";
        dragTodo.style.top = pageY - shiftY + "px";
    }
